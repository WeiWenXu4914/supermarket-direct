<template>
    <div class="video-detail-small">
        <van-icon name="arrow-left" size="0.6rem" color="#fff" @click="$router.back()" class="icon-arrow-left"/>
        ...
        <transition on name="van-fade">
            <div v-if="forwardMark" class="forward" @click="forwardMark">
                <div class="box">
                    <div class="icon"><img src="../../assets/icons/forward.png" alt=""></div>
                    <div class="text">
        ...
        <div class="more-recommend" v-if="videoList.length !== 0">
            ...
            <div class="video-items">
                <div class="wrapper">
                    <div class="item" v-for="(item,index) in videoList" :key="index" @click="goDetail(item)">
                        <van-image
                            width="4rem"
                            height="2.5rem"
                            lazy-load
        ...
        <div class="article-handle" v-if="!inputShow">
            ...
            <div class="changeStatusKey" v-show="changeStatus" @click="changeStatu">
                <img src="./img/keyboard.svg" alt="">
            </div>

            </div>
            <div class="inputd" @click.stop="inputChange" v-show="!changeStatus">
                <span class="comm_num" v-if="commList.length>0">{{ commList.length>100?'99+':commList.length }}</span>
                <span>
...
<script>
import { articleDetail } from "./actions";
...
import { changeFouce as focus, memberLike,forwardArticles, memberCollect, GraphicRecommend,articleCommList,articleComm } from './actions/index';
export default {
    components: {
        CommList,
        ShareSheet,
    ...
    methods: {
        ...
        async getCommList() {
            ...
            if (res.code === 100) {
                ...
                this.dataAll.mem_attention_state === 1 ? this.show = false : this.show = true
        ...
        async getData() {
            ...
            this.computeVideoStyle(this.dataAll.graphic_width,this.dataAll.graphic_height);
        },
        ...
        like () {
            ...
            .then(res => {
                if (res.code === 100) {
                    state === 1 ? this.dataAll.mem_like = '已点赞' : this.dataAll.mem_like = '未点赞';
                    state === 1 ? this.dataAll.graphic_like ++ : this.dataAll.graphic_like --;
                } else {
                    Toast(res.msg);
                }
            })
            ...
            if (ua.match(/MicroMessenger/i) == 'micromessenger') {
                ...
                if (res.code == 100) {
                    ...
                    var form = {
                        ...
                        imgUrl: imgUrl,
                        desc: this.dataAll.graphic_intro || '来自'+this.dataAll.mem_name+'的分享'
                    }
                    ...
                    var form = {
                        title: this.dataAll.graphic_name,
                        link: window.location.href+'?goindex=true&key='+res.data.mem_urlkey,
                        imgUrl: this.dataAll.graphic_surface_plot || 'http://api.lejiagx.cn/static/icon/lejia_logo.png',
                        desc: this.dataAll.graphic_intro || '来自'+this.dataAll.mem_name+'的分享',
                        type: 'video',
