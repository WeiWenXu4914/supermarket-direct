<template>
    <div class="groupBookingClass">
        <div class="card" @click="goDetail(item.pgbid)" v-for="(item, index) in dataList" v-if="dataList != ''">
            <div class="thumbnail">
            ...
            <div class="detail">
                ...
                <div class="monery_num">
                    ...
                    <div class="num">
                        <van-tag type="danger">{{ item.pro_gb_num }}人团 ￥{{ item.pro_gb_open_paynum }}</van-tag>
                    </div>
                </div>
            </div>
        </div>
